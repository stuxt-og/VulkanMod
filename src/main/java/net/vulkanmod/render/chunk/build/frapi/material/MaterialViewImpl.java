...
public class MaterialViewImpl implements MaterialView {
	...
	protected static final int BLEND_MODE_BIT_LENGTH = Math.method_15342(BLEND_MODE_COUNT);
	protected static final int EMISSIVE_BIT_LENGTH = 1;
	protected static final int DIFFUSE_BIT_LENGTH = 1;
	protected static final int AO_BIT_LENGTH = Math.method_15342(TRI_STATE_COUNT);
	protected static final int GLINT_MODE_BIT_LENGTH = Math.method_15342(GLINT_MODE_COUNT);
	protected static final int SHADE_MODE_BIT_LENGTH = Math.method_15342(SHADE_MODE_COUNT);
